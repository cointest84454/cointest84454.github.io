...
$(document).ready(function() {
            ...
            $(".process__answer--first").click(function() {
                    ...
                    if (index < 9) {
                        $(".process__answer--first").css("background-color", "rgb(247, 147, 27)").css("color", "white").css("transition", "0.2s");
                        setTimeout(function() {
                                $($(".process")[index + 1]).css("display", "block"), 200
                            }
                        }
                        if (index == 9) {
                ...
                $(".process__answer--second").click(function() {
                        ...
                        $($(".process")[index]).css("display", "none");
                        if (index < 9) {
                            $(".process__answer--second").css("background-color", "rgb(247, 147, 27)").css("color", "white").css("transition", "0.2s");
                            setTimeout(function() {
                                    $($(".process")[index + 1]).css("display", "block"), 200
                                }
                            }
